...
export default function ServiceProcessingSolutionsPage() {
  const mainModules = [
    {
      icon: <CreditCard className="w-8 h-8" />,
      title: 'Корпоративный процессинг',
      description: 'Системы управления топливными картами и корпоративными программами лояльности',
      features: ['Эмиссия карт', 'Управление лимитами', 'Авторизация транзакций', 'Взаиморасчеты']
    },
    {
      icon: <CreditCard className="w-8 h-8" />,
      title: 'Интеграции',
      description: 'Подключение к банкам и платежным системам\u00A0',
      features: ['Visa', 'Mastercard', 'МИР', 'Host-to-Host']
    },
    {
      icon: <CreditCard className="w-8 h-8" />,
      title: 'Отчетность',
      description: 'Аналитика и управление финансовыми операциями',
      features: ['Транзакции', 'Взаиморасчеты', 'Аналитика', 'Экспорт']
    },
    {
      icon: <CreditCard className="w-8 h-8" />,
      title: 'Мобильные приложения',
      description: 'Приложения для управления картами и операциями',
      features: ['iOS и Android', 'Личный кабинет', 'История операций', 'Уведомления']
    }
  ];
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-5xl lg:text-7xl font-light text-white mb-6 leading-tight tracking-tight inline-block relative">
                Разработка процессинговых решений
              ...
              <p className="text-xl lg:text-2xl text-white/90 leading-relaxed mb-12 font-light">
                Системы обработки платежей и финансовых операций
              </p>

              <div className="flex flex-wrap justify-center gap-3">
                <div className="px-4 py-2 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20">
                  <span className="text-sm text-white/90">Высокая нагрузка</span>
                </div>
                <div className="px-4 py-2 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-12 lg:mb-16">
              ...
              <p className="text-xl text-medium-gray leading-relaxed max-w-2xl mx-auto">
                Надежные решения для обработки транзакций
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="bg-white rounded-2xl p-8 lg:p-12 shadow-md border border-gray-100">
              <div className="text-center mb-12 lg:mb-16">
                ...
                <p className="text-xl text-medium-gray leading-relaxed max-w-2xl mx-auto">
                  Процессинговые решения для финансовых организаций
                </p>
              </div>
            ...
            <div className="bg-primary rounded-2xl p-8 lg:p-12 text-white relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                <h3 className="text-3xl lg:text-4xl font-light mb-6 leading-tight">
                  Готовы создать процессинговое решение?
                </h3>
                <p className="text-xl text-white/90 leading-relaxed mb-8 max-w-2xl mx-auto font-light">
                  Мы разрабатываем аналогичные решения на основе корпоративного процессинга под ваши задачи
                </p>
                <Link
                  to="/products/trade-corp"
                  className="inline-flex items-center px-8 py-4 bg-white text-primary rounded-xl font-semibold hover:bg-white/90 hover:scale-105 transition-all duration-300 shadow-xl mr-4 mb-4"
                >
                  Узнать о TradeCorp
                ...
                <Link
                  to="/contact"
                  className="inline-flex items-center px-8 py-4 bg-white/10 backdrop-blur-sm text-white rounded-xl font-semibold hover:bg-white/20 border border-white/20 transition-all duration-300 mb-4"
                >
                  Обсудить проект
                </Link>
              </div>
