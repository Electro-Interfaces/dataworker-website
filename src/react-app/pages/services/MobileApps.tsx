...
export default function ServiceMobileAppsPage() {
  const mainModules = [
    {
      icon: <Smartphone className="w-8 h-8" />,
      title: 'iOS разработка',
      description: 'Нативные приложения для iPhone и iPad',
      features: ['Swift', 'SwiftUI', 'App Store', 'Apple Pay']
    },
    {
      icon: <Smartphone className="w-8 h-8" />,
      title: 'Android разработка',
      description: 'Нативные приложения для Android устройств',
      features: ['Kotlin', 'Jetpack Compose', 'Google Play', 'Google Pay']
    },
    {
      icon: <Smartphone className="w-8 h-8" />,
      title: 'Backend интеграция',
      description: 'Связь с серверной частью и API',
      features: ['REST API', 'WebSocket', 'Push-уведомления', 'Синхронизация данных']
    },
    {
      icon: <Smartphone className="w-8 h-8" />,
      title: 'Дизайн и UX',
      description: 'Современный интерфейс и удобство использования',
      features: ['Material Design', 'Human Interface Guidelines', 'Анимации', 'Адаптивность']
    }
  ];
              ...
              <h1 className="text-5xl lg:text-7xl font-light text-white mb-6 leading-tight tracking-tight inline-block relative">
                ...
                <sup className="absolute top-0 -right-7 lg:top-0 lg:-right-10">
                  <div className="w-6 h-6 lg:w-9 lg:h-9 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 flex items-center justify-center">
                    <Smartphone className="w-3.5 h-3.5 lg:w-5 lg:h-5 text-white" />
                  </div>
                </sup>
              </h1>

              <p className="text-xl lg:text-2xl text-white/90 leading-relaxed mb-12 font-light">
                Нативные iOS и Android приложения для вашего бизнеса
              </p>

              <div className="flex flex-wrap justify-center gap-3">
                <div className="px-4 py-2 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20">
                  <span className="text-sm text-white/90">iOS</span>
                </div>
                <div className="px-4 py-2 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20">
                  <span className="text-sm text-white/90">Android</span>
                </div>
                <div className="px-4 py-2 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20">
                  <span className="text-sm text-white/90">Нативная разработка</span>
                </div>
                <div className="px-4 py-2 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20">
                  <span className="text-sm text-white/90">Современный дизайн</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-12 lg:mb-16">
              ...
              <p className="text-xl text-medium-gray leading-relaxed max-w-2xl mx-auto">
                Полный цикл создания мобильных приложений
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="bg-white rounded-2xl p-8 lg:p-12 shadow-md border border-gray-100">
              <div className="text-center mb-12 lg:mb-16">
                ...
                <p className="text-xl text-medium-gray leading-relaxed max-w-2xl mx-auto">
                  Мобильные приложения для различных сфер бизнеса
                </p>
              </div>
