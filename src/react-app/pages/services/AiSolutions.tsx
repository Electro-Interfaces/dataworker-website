        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-white mb-6 leading-[1.1] tracking-tight">
              Решения на базе <span className="text-transparent bg-clip-text bg-gradient-to-r from-navy-400 to-navy-300">AI</span>
            </h1>
         ...
         <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
               <h2 className="text-3xl lg:text-5xl font-bold mb-6 leading-tight">
                  <span className="text-navy-500">Data-Driven</span> подход к разработке
               </h2>
               ...
               <div className="space-y-6">
                  <div className="flex gap-4">
                     <div className="w-12 h-12 rounded-full bg-navy-900/50 flex items-center justify-center border border-navy-700 flex-shrink-0">
                        <Cpu className="w-6 h-6 text-navy-400" />
                     </div>
                     <div>
            ...
            <div className="lg:w-1/2 relative">
               <div className="absolute inset-0 bg-navy-500/20 blur-3xl rounded-full"></div>
                   ...
                   <div className="space-y-3">
                      <div>
                        ...
                        <div className="h-2 bg-gray-800 rounded-full overflow-hidden">
                           <div className="h-full bg-navy-500 w-[85%]"></div>
                        </div>
                      </div>
                      <div>
                        <div className="flex justify-between text-xs text-gray-400 mb-1">
